...
var xp = require("../../commands/info/xp.json");
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 12:
            ...
            message.reply("Please add what amount you would like to set ".concat(member, "'s xp to."));
            _context.next = 26;
            break;
          ...
          case 20:
            ...
            message.channel.send("Success, ".concat(member, "'s xp have been set to ").concat(xp[msgmention.id].xp));
            _context.next = 26;
            break;
